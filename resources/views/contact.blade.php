...
<div class="page-wraper">
    ...
    <div class="page-content">
        <!-- inner page banner -->
        <div class="dez-bnr-inr overlay-black-middle" style="background-image:url(../resources/images/background/bg4.jpg);">
            <div class="container">
        ...
        @if(Session::get('name'))
            <div>帳號: {{Session::get('name')}}</div>
        @endif
                
        
        @if(Session::get('realname'))
            <div>名稱: {{Session::get('realname')}}</div>
        @endif
